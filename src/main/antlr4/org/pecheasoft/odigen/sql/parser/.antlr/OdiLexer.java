...
public class OdiLexer extends Lexer {
	...
	public static final int
		...
		WAIT=325, BEGIN=326, EXIT=327, ANNOTATION=328, CMNT=329, LISTAGG=330, 
		WITHIN_GROUP=331, EXPORT=332, IMPORT=333, REGENERATE=334, OR_REPLACE=335, 
		TYPE=336, STAGING=337, CONNECT=338, ODI=339, IGNORE_NULLS=340, RESPECT_NULLS=341, 
		CONVERT=342, DATETIME=343, VARCHAR_MAX=344, VARCHAR2_MAX=345, CONTINUE=346, 
		CHECK=347, CONTROL=348, FLOW=349, STATIC=350, ACTIVE=351, MESSAGE=352, 
		KEEP=353, PIVOT=354, UNPIVOT=355, INCLUDE=356, Odi_Sequence=357, Odi_Variable=358, 
		Odi_Variable_Literal=359, Hint_Start=360, Hint_End=361, BlockComment=362, 
		LineComment=363, Regular_Identifier=364, Quoted_Identifier=365, Character_String_Literal=366, 
		FreeCode=367, Space=368, New_Line=369, White_Space=370, BAD=371;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DISTINCT", "DATASET", "END", "ELSE", "EXCEPT", "FALSE", "FULL", "FROM", 
			"GROUP", "HAVING", "ILIKE", "IN", "INNER", "INTERSECT", "INTO", "IS", 
			"JOIN", "LEADING", "LEFT", "LIKE", "LIMIT", "MAPPING", "NATURAL", "NOT", 
			"NULL", "ON", "OR", "ORDER", "OUTER", "OVER", "PACKAGE", "PROCEDURE", 
			...
			"Digit", "REAL_NUMBER", "NULLS", "MINUS_SET", "DATASTORE", "ALIAS", "RESOURCE", 
			"FILE", "HEADING", "RECORD_SEP", "FIELD_SEP", "TEXT_DELIM", "DECIMAL_SEP", 
			"FIXED", "DELIMITED", "PHYS_LENGTH", "SCD", "ADD_ROW_ON_CHANGE", "CURRENT_RECORD_FLAG", 
			"START_TIMESTAMP", "END_TIMESTAMP", "NATURAL_KEY", "OVERWRITE_ON_CHANGE", 
			"SURROGATE_KEY", "SCD_BEHAVIOR", "MODEL", "WITH_NAME", "LOGICAL_SCHEMA", 
			"FOLDER", "SUBMODEL", "MODIFY", "REPLACE", "CONTEXT", "XKM", "SEQUENCEFILE", 
			"FIELDS", "TERMINATED", "ESCAPED", "DEFINED", "SERDE", "SERDEPROPERTIES", 
			"TEXTFILE", "RCFILE", "ORC", "PARQUET", "AVRO", "INPUTFORMAT", "OUTPUTFORMAT", 
			"TEMPORARY", "STORED_AS", "TBLPROPERTIES", "ROW_FORMAT", "INTEGRATION_TYPE", 
			"UPDATE_KEY", "REJECT", "PERCENT", "PRIMARY_KEY", "ALTERNATE_KEY", "OLAP_TYPE", 
			"CONSTRAINT", "ODI_Tag_Start", "ODI_Tag_End", "ODIREF", "CURSOR", "SUCCESS", 
			"ERROR", "GOTO", "DECLARE", "REFRESH", "RETRY", "WAIT", "BEGIN", "EXIT", 
			"ANNOTATION", "CMNT", "LISTAGG", "WITHIN_GROUP", "EXPORT", "IMPORT", 
			"REGENERATE", "OR_REPLACE", "TYPE", "STAGING", "CONNECT", "ODI", "IGNORE_NULLS", 
			"RESPECT_NULLS", "CONVERT", "DATETIME", "VARCHAR_MAX", "VARCHAR2_MAX", 
			"CONTINUE", "CHECK", "CONTROL", "FLOW", "STATIC", "ACTIVE", "MESSAGE", 
			"KEEP", "PIVOT", "UNPIVOT", "INCLUDE", "Odi_Sequence", "Odi_Variable", 
			"Odi_Variable_Literal", "Hint_Start", "Hint_End", "BlockComment", "LineComment", 
			"Regular_Identifier", "Quoted_Identifier", "New_Line_Characters", "Control_Characters", 
			"Extended_Control_Characters", "Character_String_Literal", "EXPONENT", 
			"HEX_DIGIT", "ESC_SEQ", "OCTAL_ESC", "UNICODE_ESC", "FreeCode", "Space", 
			"New_Line", "White_Space", "BAD"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"REFRESH", "RETRY", "WAIT", "BEGIN", "EXIT", "ANNOTATION", "CMNT", "LISTAGG", 
			"WITHIN_GROUP", "EXPORT", "IMPORT", "REGENERATE", "OR_REPLACE", "TYPE", 
			"STAGING", "CONNECT", "ODI", "IGNORE_NULLS", "RESPECT_NULLS", "CONVERT", 
			"DATETIME", "VARCHAR_MAX", "VARCHAR2_MAX", "CONTINUE", "CHECK", "CONTROL", 
			"FLOW", "STATIC", "ACTIVE", "MESSAGE", "KEEP", "PIVOT", "UNPIVOT", "INCLUDE", 
			"Odi_Sequence", "Odi_Variable", "Odi_Variable_Literal", "Hint_Start", 
			"Hint_End", "BlockComment", "LineComment", "Regular_Identifier", "Quoted_Identifier", 
			"Character_String_Literal", "FreeCode", "Space", "New_Line", "White_Space", 
			"BAD"
		};
	}
	...
	public OdiLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "OdiLexer.g4"; }
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		...
		case 398:
			...
			break;
		case 402:
			Character_String_Literal_action((RuleContext)_localctx, actionIndex);
			break;
		}
	}
	...
	private void Character_String_Literal_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 2:
