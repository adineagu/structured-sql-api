// Generated from c:/Sources/odi-generator/OdiGenLibraries/odigen-odi-parse/src/main/antlr4/org/apache/tajo/engine/parser/SQLLexer.g4 by ANTLR 4.13.1
...
public class SQLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"CMNT", "LISTAGG", "WITHIN_GROUP", "EXPORT", "IMPORT", "REGENERATE", 
			"OR_REPLACE", "TYPE", "STAGING", "CONNECT", "ODI", "IGNORE_NULLS", "RESPECT_NULLS", 
			"CONVERT", "DATETIME", "VARCHAR_MAX", "VARCHAR2_MAX", "CONTINUE", "CHECK", 
			"CONTROL", "FLOW", "STATIC", "ACTIVE", "MESSAGE", "KEEP", "PIVOT", "UNPIVOT", 
			"INCLUDE", "Odi_Sequence", "Odi_Variable", "Odi_Variable_Literal", "Hint_Start", 
			...
			"EXPONENT", "HEX_DIGIT", "ESC_SEQ", "OCTAL_ESC", "UNICODE_ESC", "FreeCode", 
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		...
		case 400:
			...
			break;
		case 406:
			FreeCode_action((RuleContext)_localctx, actionIndex);
			break;
		}
	}
	...
	private void FreeCode_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 3:
			 setText(getText().substring(3).substring(0, getText().substring(3).length()-2)); 
			break;
		}
	}
