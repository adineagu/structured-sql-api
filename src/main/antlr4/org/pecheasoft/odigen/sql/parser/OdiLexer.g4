...
ANNOTATION: '@'(Regular_Identifier)+ (Space|Control_Characters)* (LEFT_PAREN (Space|Control_Characters)* (Regular_Identifier Space* EQUAL Space* Quoted_Identifier) ((Space|Control_Characters)* COMMA (Space|Control_Characters)* (Regular_Identifier Space* EQUAL Space* Quoted_Identifier))* (Space|Control_Characters)* RIGHT_PAREN)?; 
