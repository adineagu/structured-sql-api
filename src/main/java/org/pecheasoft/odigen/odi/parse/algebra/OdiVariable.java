 ...
 * @author Adi Neagu
 */
public class OdiVariable extends OdiExpr {

    private String projectName;
    private String name;
    private boolean global;
    private LiteralValue.LiteralType valueType;

    public OdiVariable(String projectName, String name) {
    ...
    public void setValueType(LiteralValue.LiteralType valueType) {
