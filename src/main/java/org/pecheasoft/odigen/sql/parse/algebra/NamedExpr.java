...
/**
 * <code>NamedExpr</code> is an expression which can be aliased in a target
 * list.
 *
 * <pre>
 ...
 * </pre>
 *
 * We define each expression in expr1 - expr4 as a named expression. In database
 * community, each of them is called target or an expression in a select list,
